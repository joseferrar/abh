        ...
        <Grid container spacing={2} marginTop={2}>
          <Grid item xs={12} sm={4} md={7}>
            <Paper style={classes.section} elevation={0}>
              <Grid container>
                ...
                <Grid item xs={12} sm={4} md={7}>
                  <Typography
                    style={{ color: "#000", textAlign: "left", width: "100%" }}
                  >
          ...
          <Grid item xs={12} sm={4} md={5}>
            ...
            <Paper style={classes.section} elevation={0}>
              ...
              <Divider style={{ width: "250px", marginLeft: 35 }} />
              <ul style={{ display: "flex", listStyle: "none" }}>
                <li>
                  <Typography
                    variant="subtitle1"
        ...
        <Grid container>
            ...
            <Paper style={classes.section} elevation={0}>
              <Grid container>
                <Grid item xs={12} sm={4} md={10}>
                  <Box
                    style={{ backgroundColor: "rgb(0 0 0 / 10%)", padding: 5, width: "680px" }}
                  >
                    <Typography
                      variant="subtitle1"
          ...
          <Grid item xs={12} sm={4} md={5} marginTop={2.5}>
            <Grid item xs={12} sm={4} md={12}>
              <Box style={{ backgroundColor: "rgb(0 0 0 / 10%)", padding: 5, width: "680px"  }}>
                <Typography
                  variant="subtitle1"
                  style={{ fontWeight: "bold", marginLeft: "12px" }}
                >
